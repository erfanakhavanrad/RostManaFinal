...
public class FragmentShrub extends Fragment implements ChangingFragmentsInterface, FlowersAdapter.CallBack {
...
//                    Toast.makeText(getContext(), "success" + seasonalModel.getName(), Toast.LENGTH_SHORT).show();
    ...
    public void callBack(SeasonalModel seasonalModel) {
        ...
        Navigation.findNavController(secondView).navigate(R.id.action_fragmentShrub_to_fragment_Plant_Details, bundle);
    }
}
