...
public class FragmentCactus extends Fragment implements ChangingFragmentsInterface, FlowersAdapter.CallBack {
...
//        NavHostFragment.findNavController(FragmentCactus.this);
//        Navigation.findNavController(view).navigate(R.id.fragment_Plant_Details);
        NavController navController = NavHostFragment.findNavController(FragmentCactus.this);
...
//                    Toast.makeText(getContext(), "success" + seasonalModel.getName(), Toast.LENGTH_SHORT).show();
    ...
    public void callBack(SeasonalModel seasonalModel) {
        ...
        Navigation.findNavController(secondView).navigate(R.id.action_fragmentCactus_to_fragment_Plant_Details, bundle);
    }
}
